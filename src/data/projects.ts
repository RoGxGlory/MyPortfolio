...
export const projects: Project[] = [
  {
    ...
    featured: true,
    download: {
      url: "https://downloads.rayanebenabdeljalil.com/Spellbound%20Survival/SpellBound%20Survival%20Setup%201.0.1.exe",
      label: "Download Installer (v1.0.1)",
      platform: "Windows 10 / 11 (64-bit)",
      version: "v1.0.1",
      fileSize: "162 MB",
      installedSize: "702.6 MB",
  ...
  },
  {
    id: "the-line",
    title: "The Line",
    description: "A Unity WebGL game challenging players with precision movement and timing-based mechanics.",
    fullDescription:
    ...
    myRole: "Solo Developer — Designed and developed the entire game, from concept to WebGL deployment on itch.io.",
