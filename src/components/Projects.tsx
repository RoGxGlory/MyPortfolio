    ...
    <section id="projects" className="py-24 relative">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg">My latest game development work and community initiatives</p>
        </div>
            ...
            <div key={project.id} className="max-w-6xl mx-auto mb-12">
              <Card className="glass-card border-primary/30 overflow-hidden group hover:border-primary/60 transition-all duration-500 relative">
                <div className="absolute top-4 right-4 z-10">
                  <span className="text-xs font-bold px-3 py-1.5 rounded-full bg-primary text-primary-foreground uppercase tracking-wider">
                    🎮 Live Game
                  </span>
                </div>
                <div className="grid md:grid-cols-2">
                  {project.image ? (
                    ...
                    <div
                      className={`h-full min-h-[280px] bg-gradient-to-br ${project.gradient} opacity-80 group-hover:opacity-100 transition-opacity`}
                    />
                  )}
                  <CardContent className="p-8 flex flex-col justify-center">
                    <h3 className="text-3xl md:text-4xl font-bold mb-4">{project.title}</h3>
                    <p className="text-muted-foreground mb-5 text-lg leading-relaxed">{project.description}</p>
                    ...
                    <div className="flex flex-wrap gap-3">
                      {project.demo && (
                        <Button size="default" variant="default" className="gap-2" asChild>
